...
plot \
	...
	"daten/2014/freigabe-alter.tsv" u 1:($2*100/$7):($2*100/$7/sqrt($2)) w l lc rgb"white" lw 2 t"", \
	"daten/2014/freigabe-alter.tsv" u 1:($3*100/$7):($3*100/$7/sqrt($3)) w l lc rgb"yellow" lw 2 t"", \
	"daten/2014/freigabe-alter.tsv" u 1:($4*100/$7):($4*100/$7/sqrt($4)) w l lc rgb"green" lw 2 t"", \
	"daten/2014/freigabe-alter.tsv" u 1:($5*100/$7):($5*100/$7/sqrt($5)) w l lc rgb"blue" lw 2 t"", \
	"daten/2014/freigabe-alter.tsv" u 1:($6*100/$7):($6*100/$7/sqrt($6)) w l lc rgb"red" lw 2 t"", \
