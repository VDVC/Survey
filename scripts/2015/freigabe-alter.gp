...
fit f00(x) "daten/2015/freigabe-alter.tsv" u 1:($3*100/$8):($3*100/$4/sqrt($3)) via m00,b00
fit f06(x) "daten/2015/freigabe-alter.tsv" u 1:($7*100/$8):($7*100/$4/sqrt($7)) via m06,b06
fit f12(x) "daten/2015/freigabe-alter.tsv" u 1:($4*100/$8):($4*100/$4/sqrt($4)) via m12,b12
fit f16(x) "daten/2015/freigabe-alter.tsv" u 1:($5*100/$8):($5*100/$4/sqrt($5)) via m16,b16
fit f18(x) "daten/2015/freigabe-alter.tsv" u 1:($6*100/$8):($6*100/$4/sqrt($6)) via m18,b18
