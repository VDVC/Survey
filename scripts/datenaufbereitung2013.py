...
with io.open(rohdaten, encoding='utf8') as f:
    ...
    for spss_entry in reader:
        ...
        for item in spss_entry[25:139]:
            results.write(u'"'+item+u'";')
        if(len(spss_entry[139]) > 0):
            zensurinfo.write(spss_entry[139]+u'\n\n')
        for item in spss_entry[140:151]:
            results.write(u'"'+item+u'";')
#        if(len(spss_entry[151]) > 0):
#            zensurinfo.write(spss_entry[151]+u'\n\n')
        for item in spss_entry[152:167]:
            results.write(u'"'+item+u'";')
